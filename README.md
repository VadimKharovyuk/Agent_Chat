...
Агенти мають доступ до **двох інструментів пошуку**:

| Інструмент | Для чого |
|---|---|
| 🌍 Wikipedia | Визначення, факти, історія, біографії |
| 🔍 Tavily Search | Актуальні новини, свіжа статистика, поточні події |
...
```
Перед відповіддю шукай у Wikipedia або в інтернеті факти про [тему].
Використовуй реальні дані — не вигадуй цифри і статистику.
```

> ⚠️ Tavily Search потребує API ключ — отримай безкоштовно на [tavily.com](https://tavily.com) (1000 запитів/місяць)
```
