...
public class WikipediaSearchTool {
    ...
    @Tool(description = """
        ...
        Використовуй для визначень, фактів, історії, біографій, наукових понять.
        Використовуй ТІЛЬКИ одне-два слова для пошуку.
        Наприклад: 'квантова фізика', 'Маркс', 'демократія', 'Tesla', 'ШІ'.
        НІКОЛИ не використовуй довгі фрази.
        """)
